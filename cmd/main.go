...
import (
	...
	"github.com/heheh13/Custom-Secret-Controller/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "66e20efa.heheh.org",
	...
	if err = (&controller.CustomSecretReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "CustomSecret")
		os.Exit(1)
	}
